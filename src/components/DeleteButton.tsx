  ...
  return (
    <>
      ...
      <dialog
        ...
        className="m-auto w-[calc(100%-2rem)] max-w-md rounded-lg border border-slate-200 bg-white p-0 shadow-xl backdrop:bg-slate-900/50"
        ...
        <div className="p-5 sm:p-6">
          ...
          <div className="mt-5 flex flex-wrap justify-end gap-3">
            <button
              ...
              disabled={deleting}
              className="rounded-md px-4 py-2 text-sm font-medium text-slate-600 transition-colors hover:bg-slate-100 hover:text-slate-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-slate-900 focus-visible:ring-offset-2 disabled:opacity-50"
            >
              Cancel
            </button>
